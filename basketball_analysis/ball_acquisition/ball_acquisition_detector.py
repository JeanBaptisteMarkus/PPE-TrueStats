...
class BallAcquisitionDetector:
    def __init__(self):
        self.possession_threshold = 50 # Distance threshold to consider a player in possession of the ball
        self.min_frames = 13 # Number of frames to consider for possession
        self.containment_threshold = 0.8 # overlap threshold to consider ball contained within player's bbox
